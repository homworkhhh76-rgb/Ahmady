...
(function(){
  ...
  function v32FilterSubscriberDataset(ds,value){
    ...
    if(ds==='settings'){
      ...
      const keys=['platformName','networkName','ownerName','networkLogo','networkLogoKey','networkLogoName','networkLogoSize','appLanguage'];
